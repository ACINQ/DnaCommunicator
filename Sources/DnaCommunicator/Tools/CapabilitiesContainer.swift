...
public struct CapabilitiesContainer: CustomStringConvertible {
	...
	///
	public var mLc: UInt16
	
	/// NDEF files
	/// TLV blocks that contain information to control and manage each available NDEF file.
	///
	public var files: [CtrlTLV]
	
	public init(len: UInt16, version: UInt8, mLe: UInt16, mLc: UInt16, files: [CtrlTLV]) {
		self.len = len
	...
	public var description: String {
		...
		output += " - len: \(len)\n"
		output += " - v: \(Utils.leftNibble(version)).\(Utils.rightNibble(version))\n"
		output += " - mLe: \(mLe)\n"
		output += " - mLc: \(mLc)\n"
		for file in files {
	...
	public static func ntag424Dna_defaultValue() -> CapabilitiesContainer {
...
public struct CtrlTLV: CustomStringConvertible {
	...
	/// - 80h-FEh: proprietary (card-specific protocol)
	///
	public var writeAccess: UInt8
	
	public init(t: UInt8, l: UInt8, fileId: [UInt8], fileSize: UInt16, readAccess: UInt8, writeAccess: UInt8) {
		self.t = t
		self.l = l
		self.fileId = fileId
	...
	public static func ntag424Dna_defaultFile2() -> CtrlTLV {
		return CtrlTLV(
			t: 4,
			l: 6,
			fileId: [0xe1, 0x04],
	...
	public static func ntag424Dna_defaultFile3() -> CtrlTLV {
		return CtrlTLV(
			t: 5,
			l: 6,
			fileId: [0xe1, 0x05],
