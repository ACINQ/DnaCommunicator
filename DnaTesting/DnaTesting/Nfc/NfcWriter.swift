...
fileprivate let log = Logger.init(subsystem: "DnaTesting", category: "NfcWriter")
fileprivate let dnaLog = Logger.init(subsystem: "DnaTesting", category: "DnaCommunicator")
